  ...
  return (
    <header className='w-96vw overflow-hidden h-90vh z-100'>
      <div className="w-11/12 my-0 mx-auto grid grid-cols-2 items-center gap-x-20 h-full mt-8">
        <div className="my-4 pt-6 pb-12">
          <h1 className='text-5xl font-bold mb-8 animate-slide-right'>
            Generate valid certificates with Blockcertify
          </h1>
          <p className='my-4 pb-9 text-1.5xl mb-8 animate-slide-left'>
         ...
         font-semibold px-12 py-4 text-3xl rounded-full ">
